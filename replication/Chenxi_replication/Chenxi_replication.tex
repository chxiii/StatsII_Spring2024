...
\lstinputlisting[language=R, basicstyle=\footnotesize, firstline=18, lastline=19]{replication.R}
...
\lstinputlisting[language=R, basicstyle=\footnotesize, firstline=45, lastline=46]{replication.R}
where we can get AIC value is 114676.
\par
\noindent Also, we want to try the logistic model without interactions:
\lstinputlisting[language=R, basicstyle=\footnotesize, firstline=47, lastline=48]{replication.R}
